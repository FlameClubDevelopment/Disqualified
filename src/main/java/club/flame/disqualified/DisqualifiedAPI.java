...
public class DisqualifiedAPI {
    ...
    public static String getRankName(Player player) {
        PlayerData playerData = PlayerData.getPlayerData(player.getUniqueId());
        if (playerData == null) return Disqualified.getInstance().getRankManager().getDefaultRank().getName();
        return playerData.getHighestRank().getName();
    }

    public static String getRankPrefix(Player player) {
        PlayerData playerData = PlayerData.getPlayerData(player.getUniqueId());
        if (playerData == null) return Disqualified.getInstance().getRankManager().getDefaultRank().getPrefix();
    ...
    public static String getRankSuffix(Player player) {
        PlayerData playerData = PlayerData.getPlayerData(player.getUniqueId());
        if (playerData == null) return Disqualified.getInstance().getRankManager().getDefaultRank().getSuffix();
