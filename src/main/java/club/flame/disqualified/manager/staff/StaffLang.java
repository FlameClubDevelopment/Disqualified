...
public class StaffLang {
    ...
    public static void StaffJoinMessage(String player, String server) {
        String format = Disqualified.getInstance().getMessagesConfig().getConfiguration().getString("NETWORK.STAFF-ALERTS.JOIN")
    ...
    public static void StaffLeaveMessage(String player, String server) {
        String format = Disqualified.getInstance().getMessagesConfig().getConfiguration().getString("NETWORK.STAFF-ALERTS.QUIT")
                .replace("<player>", player)
                .replace("<server>", server
        );
    ...
    public static void StaffSwitchMessage(String player, String lastserver, String actualserver) {
        String format = Disqualified.getInstance().getMessagesConfig().getConfiguration().getString("NETWORK.STAFF-ALERTS.SWITCH")
                .replace("<player>", player)
    ...
    public static void sendReport(String sender, String target, String server, String reason) {
        String format = Disqualified.getInstance().getSettingsConfig().getConfiguration().getString("SETTINGS.REPORT.MSG.STAFF")
                .replace("<server>", server)
