...
public class Utils {
    ...
    public static void globalBroadcast(Player player, String message) {
        ...
        player.sendPluginMessage(Disqualified.getInstance(), "BungeeCord", output.toByteArray());
    }
    ...
    public static String getUsernameById(int userid) {
        if (Disqualified.serverName.equals("%%__USER__%")) {
            return "Robot";
        } else {
            try {
    ...
    public static String getIP() {
        ...
        try {
            ...
            Disqualified.getInstance().getLogger().info("[License] Error in check your host ip!");
//            Bukkit.getConsoleSender().sendMessage("&c&lYour LocalHost IP are unknown , please check what happend on your intertnet! ERROR LOG:");
        ...
        return ipAddress + ":" + Disqualified.getInstance().getServer().getPort();
    }
